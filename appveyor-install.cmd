...
echo Downloading Lazarus 2.0.6 for Windows 32 bit
rem curl -fsSL -o laz-setup.exe "https://www.dropbox.com/s/xe0l2wldh4pfofu/lazarus-1.6.4-fpc-3.0.2-win32.exe?dl=1"
curl -fsSL -o laz-setup.exe "https://sourceforge.net/projects/lazarus/files/Lazarus Windows 32 bits/Lazarus 2.0.6/lazarus-2.0.6-fpc-3.0.4-win32.exe/download"
...
curl -fsSL -o laz-cross-setup.exe "https://sourceforge.net/projects/lazarus/files/Lazarus Windows 32 bits/Lazarus 2.0.6/lazarus-2.0.6-fpc-3.0.4-cross-x86_64-win64-win32.exe/download"
